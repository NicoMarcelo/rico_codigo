function Calculo_notas(){
    ...
    if(!/^[A-Za-zÁÉÍÓÚáéíóúÑñ]*$/.test(nombre) || nombre === "" || nombre.length < 3 || nombre.length > 20){
        ...
        document.write("<div class= 'contenido'><b> Has reprobado ❤🎶. <br> Tu asignatura es: "+seleccion+" <br> Tu nota es: </b>"+prom_final2+
        "<br> <b> Estudiante:"+nombre+"</b> <h2 class = 'titulito'>Tus notas son: </h2>"+
        "</div>"+"<div class='tablita'><table class='tabla'>"+
        "<tr> <td class='unidad'><b>UNIDAD 1 (33%)</b></td>"+
        "<td class='unidad'><b>UNIDAD 2 (33%)</b></td>"+
        "<td class='unidad'><b>UNIDAD 3 (33%)</b></td>"+
        "</tr>"+
        "<tr>"+
        ...
        "</tr>"+
        "<tr>"+
        "<td class='ds'><b>Nota 2: </b>"+uni1_n2+" </td>"+
        "<td class='ds'><b>Nota 2: </b>"+uni2_n2+" </td>"+
        "<td class='ds'><b>Nota 2: </b>"+uni3_n2+" </td>"+
        "<tr>"+
